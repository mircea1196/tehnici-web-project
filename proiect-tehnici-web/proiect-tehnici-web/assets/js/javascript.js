...
if(!document.getElementById("pareri")) {
	myFunction(event);	
	return;
}
}
...
function showDescription(descriptionId, actionDescriptionId) {
	if(document.getElementById(descriptionId).style.display === 'block') {
		document.getElementById(descriptionId).style.display = "none";
		document.getElementById(actionDescriptionId).innerText = 'Vezi scurta descriere';
	} else {
		document.getElementById(descriptionId).style.display = "block";
		document.getElementById(actionDescriptionId).innerText = 'Ascunde scurta descriere';
	}
}
